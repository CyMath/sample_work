# Running an optimization in BackTrader
# Importing required libraries

import datetime
import backtrader as bt
from MACrossover import *
...
data = bt.feeds.YahooFinanceCSVData(
    dataname='/Users/cyrusmatheson/Documents/Python FIles/TSLA.csv',
...
cerebro.optstrategy(MACrossover, pfast=range(5, 20), pslow=range(50, 100))  # Add the trading strategy
